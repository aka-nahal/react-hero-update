...
if (__DEV__) {
  // Add peakhero script to page in development
  webpackConfig.entry.peakhero = paths.client('peakhero/peakhero-api.js')
} else if (__PROD__) {
  // Add async peakhero script
  webpackConfig.entry.peakhero = paths.client('peakhero/_include-peakhero-api.min.js')
}
...
webpackConfig.module.loaders.push(
  ...
  {test: /\.woff2(\?\S*)?$/, loader: 'url?prefix=fonts/&name=[path][name].[ext]&limit=10000&mimetype=application/font-woff2'},
