...
export default class InstallationPage extends React.Component {
  static propTypes = {
            ...
            <div className='page-header-content'>
              <div className='page-title text-center'>
                ...
                <div className='header-buttons-wrapper'>
                  <Link to={`/campaigns/${routeParams.campaign}/popups/${routeParams.popup}/target_sets`}
                        ...
                        <div className='platform-content'>
                          <Tab.Content animation>
                            ...
                            <Tab.Pane eventKey='second'>
                              <p>The easiest way to install ConvertHero on a Wordpress website is to use our plugin. Follow these steps to
                                get set up.</p>
                              ...
                              <p>
                                <img className='img-responsive'
                                  src='
                                  https://s3.amazonaws.com/groovehq/uploaded/atatzqbbeu76qaz98gq09g6hz97z8jwhnfw9c3czmnphsdee2e?1466483675'
                                  alt='' />
                              </p>
                            ...
                            <Tab.Pane eventKey='ninth'>
                              ...
                              <InstallationCode />
                              <p>
                                <span>In this guide we will take you through the steps to install ConvertHero on your Drupal website.</span>
                              </p>
                              <p>&nbsp;</p>
